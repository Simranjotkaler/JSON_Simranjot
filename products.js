...
let url = 'https://github.com/Simranjotkaler/JSON-WEEK8/blob/master/lab-8-files/lab-8-files/products.json';
...
function weirdDeals(jsonObj) {
    ...
    for (let i = 0; i < weirdDeals.length; i++) {
        ...
        img.setAttribute('src', 'https://github.com/Simranjotkaler/JSON-WEEK8/tree/master/lab-8-files/lab-8-files/images' + weirdDeals[i].image);
...
useAsynchronous('https://github.com/Simranjotkaler/JSON-WEEK8/blob/master/lab-8-files/lab-8-files/products.json');
